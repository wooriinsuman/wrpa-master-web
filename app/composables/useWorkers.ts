...
type SetWorkerAssignmentsRequest = components['schemas']['SetWorkerAssignmentsRequest']
...
export function useWorkers() {
  ...
  return {
    ...
    setAssignments: (id: string, body: SetWorkerAssignmentsRequest) =>
      api(`/workers/${id}/assignments`, { method: 'PUT', body }),
  }
}
